...
public class AyudaProyect extends JFrame {
    ...
    private JLabel pregunTxt;
    private JTextField pregunTxtF;
    ...
    public void inicializarComponentes() {
        ...
        pregunTxt = new JLabel("Pregunta:");
        pregunTxt.setBounds(46, 130, 63, 20);
        getContentPane().add(pregunTxt);

        pregunTxtF = new JTextField();
        pregunTxtF.setBounds(110, 130, 135, 20);
        getContentPane().add(pregunTxtF);

     // Crea un modelo de lista predeterminado y agrega elementos de pregunta al modelo
