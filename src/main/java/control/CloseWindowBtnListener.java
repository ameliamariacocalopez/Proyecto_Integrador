...
/**
 * Clase que implementa la interfaz ActionListener para el botÃ³n de Cerrar Ventana.
 * Cierra la ventana correspondiente al hacer clic en el botÃ³n.
 */
...
//        this.closeWindow4 = addAlumn;
    ...
    /**
     * MÃ©todo que se ejecuta al hacer clic en el botÃ³n de Cerrar Ventana.
     * Cierra la ventana correspondiente.
     * @param e El evento de acciÃ³n generado por el botÃ³n de Cerrar Ventana.
     */
    @Override
